    ...
    <div class="login-container">
        ...
        <div class="login-form-section">
            ...
            <div class="social-login">
                <a href="<?= htmlspecialchars(getGoogleAuthUrl()) ?>" class="social-btn <?= empty(GOOGLE_CLIENT_ID) ? 'disabled' : '' ?>">
                ...
                <a href="<?= htmlspecialchars(getGitHubAuthUrl()) ?>" class="social-btn <?= empty(GITHUB_CLIENT_ID) ? 'disabled' : '' ?>">
